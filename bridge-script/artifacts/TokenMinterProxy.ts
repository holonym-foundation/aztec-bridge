...
export class TokenMinterProxyContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, instantiation?: DeployInstantiationOptions) {
    return DeployMethod.create<TokenMinterProxyContract>(
      wallet,
      {
        artifact: TokenMinterProxyContractArtifact,
        postDeployCtor: (instance, wallet) => TokenMinterProxyContract.at(instance.address, wallet),
        args: [],
      },
      instantiation,
    );
