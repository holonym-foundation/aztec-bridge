...
// 500 bp = 5%. This is the DEVNET rate. Mainnet is 50 bp (0.5%) — see deploy-mainnet.ts.
// Do not quote this number as Shield's fee.
...
async function testPublicExitFlow(
  ...
  const authwit = await SetPublicAuthwitContractInteraction.create(
    ...
    ownerAztecAddress,
    {
      caller: AztecAddress.fromStringUnsafe(deployed.l2ProxyContract),
