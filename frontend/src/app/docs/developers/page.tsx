...
const sections: DocsSection[] = [
  {
    ...
    content: (
      <>
        <P>
          <Code>@human.tech/clean.sdk</Code> wraps the full bridge flow — authentication, L1↔L2 transfers,
  ...
  },
  {
    ...
    content: (
      <>
        <CodeBlock lang="bash">{`npm install @human.tech/clean.sdk`}</CodeBlock>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <CodeBlock>{`import { BridgeApiError } from '@human.tech/clean.sdk'
