      ...
      <div className="bg-[#F5F5F5] rounded-md p-3.5 relative">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col mt-2.5 gap-1">
            ...
            >
              <StyledImage src={bridge.from.network?.img || '/assets/svg/ethLogo.svg'} alt="" className="h-6 w-6" />
          ...
          <div className="flex flex-col mt-2.5 gap-1">
            ...
            >
              <StyledImage src={bridge.from.token?.img || ''} alt="" className="h-6 w-6" />
      ...
      <div className="mt-2 bg-[#F5F5F5] rounded-md p-3.5">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col mt-2.5 gap-1">
            ...
            >
              <StyledImage src={bridge.to.network?.img || ''} alt="" className="h-6 w-6" />
          ...
          <div className="flex flex-col mt-2.5 gap-1">
            ...
            >
              <StyledImage src={bridge.to.token?.img || ''} alt="" className="h-6 w-6" />
              <p className="text-16 font-medium text-latest-black-100">
